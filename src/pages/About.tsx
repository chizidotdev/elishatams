    ...
    <>
      <div class="about">
        ...
        <div class="about__content">
          ...
          <div class="about__content-body">
            <p>
              ...
              around his pencils as it mademewant to draw as well; He was my
              first influence.
              <br />
              Being among other kids who had the same burning desire and
              enthusiasmserved as another form of inspiration but the best of
              them all was when I was on my way home in 2016, I sawaroadside
              artist working on a realistic drawing. I had never seen a drawing
              as good and real ashis and it was there I realise that I had to
              ...
              practical experiences, learning through trial anderror and
              studying the works of Kelvin Okafor and many other artists.it was
              here I further expandedmy knowledge on graphite, and charcoal
              drawings.
              <br />
              <br />I have been drawing profressionally for 6 years and I have
              created a lot of art pieces andalsomade numerous commissioned
        ...
        <nav class="about__nav">
          <div class="about__nav-links transition-all">
            <a
